...
using Website.EndPoint.Areas.panel.Models.Dto.Roles;
...
namespace Website.EndPoint.Areas.panel.Controllers
{
	...
	public class UsersController : Controller
	{
		...
		[HttpPost]
		public IActionResult Create(AddNewDto register)
		{
		...
		public IActionResult AddUserRole(AddUserRoleDto newRole)
		{
			...
			return RedirectToAction("UserRoles", "Users", new { Id = user.Id, area = "panel" });
		}
        #endregion
